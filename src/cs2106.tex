...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{CS2106 --- Introduction to Operating Systems}}
...
\begin{multicols*}{2}
    ...
    \input{process-abstraction.tex}
    \input{interprocess-communication.tex}
    \input{process-scheduling.tex}
    \include{synchronization.tex}
    \include{memory-management.tex}
    \include{file-systems.tex}
\end{multicols*}
\end{document}